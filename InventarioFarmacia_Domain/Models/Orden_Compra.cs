...
public class Orden_Compra
{
    ...
    public int Cantidad_Productos => LotesInvolucrados!.Sum(l => l.ProductosIndividuales!.Where(pi => pi.Id_OrdenCompra == Id).Count());

    public decimal Costo_Total => LotesInvolucrados!.Sum(l => l.Producto.Precio_Unitario * l.ProductosIndividuales!.Where(pi => pi.Id_OrdenCompra == Id).Count());
}
